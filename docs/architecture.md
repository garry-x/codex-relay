...
```
codex 启动
  → codex-relay run 设置 HTTP_PROXY=http://100.114.41.104:8443
  → codex 发送 CONNECT api.openai.com:443 到 100.114.41.104:8443
...
- 监听 Tailscale IP 上的端口（如 `100.114.41.104:8443`）
- 接收 HTTP CONNECT 请求
